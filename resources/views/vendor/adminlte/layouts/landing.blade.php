...
<head>
    ...
    <meta property="og:title" content="A.S.D. Amo Santarcangiolese - Gestione Associazione" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="A.S.D. Amo Santarcangiolese - Gestione Associazione" />
    ...
    <title>A.S.D. Amo Santarcangiolese - Gestione Associazione</title>
        ...
        {{--<div class="container">--}}
            {{--<div class="navbar-header">--}}
                {{--<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">--}}
                    ...
                    {{--<span class="icon-bar"></span>--}}
                {{--</button>--}}
                {{--<a class="navbar-brand" href="#"><b>Amo Santarcangiolese</b></a>--}}
            {{--</div>--}}
    ...
    <div id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <h1>A.S.D. <b>Amo Santarcangiolese</b></h1>

                    <h3><a href="{{ url('/login') }}" class="btn btn-lg btn-success">Entra</a></h3>
                </div>
                {{--<div class="col-lg-2">--}}
